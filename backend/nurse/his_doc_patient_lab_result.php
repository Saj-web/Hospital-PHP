                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">View Laboratory Result</li>
                                        </ol>
                                    </div>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_add_single_lab_result.php?lab_number=<?php echo $row->lab_number ;?>" class="badge badge-success"><i class="mdi mdi-flask"></i> View Lab Result</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
