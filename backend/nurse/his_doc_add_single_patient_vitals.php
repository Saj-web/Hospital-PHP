                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">Patient Sugar Level mmol/L</label>
                                                        <input required="required" type="text"  name="vit_resprate"  class="form-control"  id="inputPassword4" placeholder="Sugar Level">
                                                    </div>
