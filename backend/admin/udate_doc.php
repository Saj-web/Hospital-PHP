<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_doc']))
		{
			...
			$query="UPDATE his_doc SET doc_fname=?, doc_lname=?,  doc_email=?, doc_pwd=?, doc_dept=?, doc_dpic=? WHERE doc_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $doc_fname, $doc_lname, $doc_email, $doc_pwd, $doc_dept, $doc_dpic, $doc_number);
			$stmt->execute();
			/*
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="doc_dept" value="<?php echo $row->doc_dept;?>" class="form-control" id="inputEmail4">
                                                </div> 
                                            </div>
