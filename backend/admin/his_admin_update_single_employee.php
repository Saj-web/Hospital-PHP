<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_nurse']))
		{
			...
			$query="UPDATE his_nurse SET nurse_fname=?, nurse_lname=?,  nurse_email=?, nurse_pwd=?, nurse_dpic=? WHERE nurse_number = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $nurse_fname, $nurse_lname, $nurse_email, $nurse_pwd, $nurse_dpic, $nurse_number);
			$stmt->execute();
			/*
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required"  type="file" name="nurse_dpic" class="btn btn-success form-control"  id="inputCity">
                                                </div>
                                            </div>                                            

                                            <button type="submit" name="update_nurse" class="ladda-button btn btn-success" data-style="expand-right">Add Employee</button>
