                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Capture <?php echo $row->nurse_fname;?> <?php echo $row->nurse_lname;?> Vitals</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required="required" readonly name="" value="<?php echo $row->nurse_fname;?> <?php echo $row->nurse_lname;?>" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Employee Department</label>
                                                        <input required="required" type="text" readonly name="" value="<?php echo $row->nurse_dept;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" required="required" readonly name="vit_pat_number" value="<?php echo $row->nurse_number;?>" class="form-control" id="inputEmail4" placeholder="DD/MM/YYYY">
                                                    </div>
