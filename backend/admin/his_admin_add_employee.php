...
<?php
    ...
    if(isset($_POST['add_doc'])) {
        ...
        if($role == 'Doctor') {
            $table = 'his_docs';
            $columns = 'doc_fname, doc_lname, doc_number, doc_email, doc_pwd,doc_dept';
        } elseif($role == 'Nurse') {
            $table = 'his_nurse';
            $columns = 'nurse_fname, nurse_lname, nurse_number, nurse_email, nurse_pwd,nurse_dept'; // Update column names for his_nurse table
        }
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <label for="department" class="col-form-label">Department</label>
                                                    <input type="text" required="required" name="doc_dept" class="form-control" id="department" >
                                                </div>
