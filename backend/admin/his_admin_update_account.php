                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    <img src="../admin/assets/images/users/<?php echo $row->ad_dpic;?>" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">

                                    
                                    <div class="text-centre mt-3">
                                        
                                        <p class="text-muted mb-2 font-13"><strong>Employee Full Name :</strong> <span class="ml-2"><?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Employee Email :</strong> <span class="ml-2"><?php echo $row->ad_email;?></span></p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="ad_fname"  class="form-control" id="firstname" placeholder="<?php echo $row->ad_fname;?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">Last Name</label>
                                                                <input type="text" name="ad_lname" class="form-control" id="lastname" placeholder="<?php echo $row->ad_lname;?>"readonly>
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" name="ad_email" class="form-control" id="useremail" placeholder="<?php echo $row->ad_email;?>"readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Profile Picture</label>
                                                                <input type="file" name="ad_dpic" class="form-control btn btn-success" id="useremail" >
                                                            </div>
                                                        </div>
