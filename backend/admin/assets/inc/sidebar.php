                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_discharge_patient.php">Discharged Patients</a>
                                    </li>
                                    <!--
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_view_employee.php">View Doctor(s)</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_nurse.php">View Nurse(s)</a>
                                    </li>
                                    <!--
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_nurse_lab_vitals.php">Nurse Vitals</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_update_account.php">Profile</a>
                                    </li>
